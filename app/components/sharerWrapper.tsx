...
const Sharer: React.FC<{ labelText?: string, shareText?: string, url?: string }> = (
  {
    labelText = "Share this page:",
    shareText,
    url
  }) => {
  const btnClass = "w-10 h-10 opacity-70 hover:opacity-100";
    ...
    <Row itemsCenter xl justifyEnd flexWrap wFull>
      ...
      <SocialShare
        ...
        buttonComponents={
          {
            fb: (props) =>
              <Button accent noPadding className={btnClass} {...props}>
                <svg className={svgClass} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100"
                     viewBox="0 0 48 48">
