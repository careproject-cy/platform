        ...
        <Row xl tabletCol justifyBetween itemsStart className="w-full">
          <Col lg className="max-w-lg">
            ...
            <Text lg className="text-white">
              <b>CARE (Cyprus Animals Rescue Effort) Project</b> is a <VLink lg tag={Link} href="https://uanafoundation.com/" target="_blank" className="text-blue-400">UANA Foundation</VLink> initiative that supports animal welfare in Cyprus. Run by devoted volunteers, it&apos;s dedicated to helping stray dogs in Cyprus.
            </Text>
